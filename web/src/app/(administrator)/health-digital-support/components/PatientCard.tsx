...
export default function PatientCard({ patient }: PatientCardProps) {
  ...
  const statusColors: Record<string, string> = {
    ...
    'Em Observação': 'bg-indigo-100 text-indigo-800',
    'Em Procedimento': 'bg-pink-100 text-pink-800',
    'Em Recuperação': 'bg-teal-100 text-teal-800',
    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h3 className="font-medium text-lg text-gray-900">{patient.personalInfo.name}</h3>
        ...
        <div className="mt-3 md:mt-0 flex items-center space-x-2">
          {latestAdmission && (
            <span className={`px-3 py-1 rounded-full text-xs font-medium ${
              statusColors[latestAdmission.status] || 'bg-gray-100 text-gray-800'
            }`}>
      ...
      {expanded && (
        <div className="px-4 pb-4 border-t border-gray-100 pt-2 bg-gray-50">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <h4 className="text-sm font-medium text-gray-500 mt-4 mb-2">Contato</h4>
              <ul className="space-y-1 text-sm">
            ...
            <div>
              <h4 className="text-sm font-medium text-gray-500 mb-2">Convênio</h4>
              <ul className="space-y-1 text-sm">
              ...
              {latestAdmission && (
                <>
                  <h4 className="text-sm font-medium text-gray-500 mt-4 mb-2">Internação Atual</h4>
                  <ul className="space-y-1 text-sm">
