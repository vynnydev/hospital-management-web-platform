    ...
    return (
      <div className="flex overflow-hidden bg-gradient-to-br from-slate-900 to-blue-950 rounded-xl">
        ...
        <div className="w-80 h-full flex flex-col bg-gradient-to-b from-blue-900/50 to-cyan-900/50 border-r border-blue-800/30">
          ...
          <div className="shrink-0 p-4 mt-72 border-t border-blue-800/30 bg-gradient-to-b from-blue-900/30 to-cyan-900/30">
            ...
            <Calendar
              ...
              classNames={{
                head_cell: "text-blue-300/80 font-normal",
                cell: "text-blue-100 hover:bg-blue-800/50 focus:bg-blue-800/50 rounded-md",
                day_selected: "bg-gradient-to-br from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600",
                day_today: "bg-blue-800/50 text-white font-semibold",
                nav_button_previous: "text-blue-300/80 hover:text-white transition-colors",
                nav_button_next: "text-blue-300/80 hover:text-white transition-colors",
                caption: "text-blue-100 font-medium"
              }}
            />
          </div>
        </div>
