...
import { userPreferencesService } from '@/services/general/preferences/UserPreferencesService';

// Props para o componente
interface CognitivaAssistantProps {
    userId?: string;
    hospitalId?: string;
...
export const CognitivaAssistant = forwardRef<CognitivaAssistantHandle, CognitivaAssistantProps>(({
  userId = 'current-user',
  hospitalId,
  ...
  autoOpenOnLogin = true
    ...
    const hospital = networkData?.hospitals.find((h: { id: string }) => h.id === selectedHospitalId);
