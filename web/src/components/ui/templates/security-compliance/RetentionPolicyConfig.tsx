  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="archiveAfter">Arquivar Após (dias)</Label>
          <div className="flex items-center space-x-2">
            <Input 
              id="archiveAfter" 
              type="number"
        ...
        <div className="space-y-2">
          <Label>Categorias de Logs</Label>
        ...
        {policy.retentionPeriod < 180 && policy.logCategories.includes('patient_data') && (
          <div className="bg-yellow-50 p-3 rounded-md border border-yellow-200 flex items-start">
            ...
            <div>
              <p className="text-sm font-medium text-yellow-700">Atenção: Política possivelmente não compliance</p>
