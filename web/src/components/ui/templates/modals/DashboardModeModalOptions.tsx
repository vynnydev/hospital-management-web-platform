...
interface DashboardModeModalOptionsProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectMode: (mode: 'fullscreen' | 'reposition') => void;
}

export const DashboardModeModalOptions: React.FC<DashboardModeModalOptionsProps> = ({
  isOpen,
  onClose,
  onSelectMode
}) => {
    const options = [
        {
          id: 'fullscreen',
          title: 'Modo TV',
          description: 'Visualize os componentes em tela cheia sem cabeçalho',
