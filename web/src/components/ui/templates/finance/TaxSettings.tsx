  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label htmlFor="vatEnabled">Aplicar Imposto sobre Serviços (ISS)</Label>
              <Switch 
                id="vatEnabled" 
          ...
          {settings.vatEnabled && (
            <div className="space-y-2">
              <Label htmlFor="vatRate">Alíquota Padrão de ISS (%)</Label>
        ...
        <h4 className="font-medium mb-4">Impostos Adicionais</h4>
        <ScrollArea className="h-[200px] rounded-md border">
          <div className="p-4 space-y-4">
            {settings.additionalTaxes.map((tax, index) => (
              <div key={index} className="flex items-start space-x-4 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="flex-1 space-y-2">
                  ...
                  <div>
                    <Label className="text-xs mb-1 inline-block">Aplicável a:</Label>
        ...
        <h4 className="font-medium mb-4">Isenções Fiscais</h4>
        <ScrollArea className="h-[200px] rounded-md border">
          <div className="p-4 space-y-4">
              ...
              <div key={index} className="flex items-start space-x-4 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="flex-1 space-y-2">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor={`exemption-name-${index}`} className="text-xs">Nome da Isenção</Label>
                      <Input 
                    ...
                    <div>
                      <Label htmlFor={`exemption-code-${index}`} className="text-xs">Código</Label>
                      <Input 
                  ...
                  <div>
                    <Label htmlFor={`exemption-description-${index}`} className="text-xs">Descrição</Label>
                    <Input 
